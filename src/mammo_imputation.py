...
from transformation.library import Imputation as iptt
from transformation.library import Normalization as nm
...
if __name__ == "__main__" :
    ...
    """ Procedimento de limpeza de dados: método de imputação
        No caso da base M162 valores ausentes afetando 86 objetos diferentes.
        
        Introdução a mineração de dados 
            by Daniel Gomes Ferrari e Leandro Nunes de Castro Silva, página 144 
    """ 
